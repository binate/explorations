...
Status: **Commits 1, 2, 4 LANDED (`8230e7fd` lvalue; `87c97d08` rvalue; docs
`a2de73a`/`9cfb7b9` spec Draft→Provisional, 2026-07-18); Commit 3 (bnlint
escaping-borrow rule) pending** (spec
