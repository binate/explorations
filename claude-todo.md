...
## CRITICAL (type-checker / wrong-code) — imports are PACKAGE-scoped, not file-scoped: a file can use a package only a SIBLING file imported, and same-alias-different-package across files silently binds to the WRONG package (2026-06-17) — 🔴 OPEN
