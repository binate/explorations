...
- **REMAINING**: (a) the named fixed-array PARSER bug (`type Row [3]int` unparseable — separate entry below) so named array types can be DECLARED at all; (b) the `conformance/matrix/globals` named-slice/named-array cells.
