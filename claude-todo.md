...
- **Interim**: the short-term native `emitPackageDescriptor` (below) unblocks native bni/unit tests now and is explicitly throwaway — the `_Package` migration step deletes it.
